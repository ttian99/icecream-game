...
// function get
// const wb = xu.getWorkbook('答题系统问题列表.xlsx');
// // const sheet = xu.getSheet(wb, '中文');
// const sheetNameArr = ['中文', '繁体', '英文'];
// let arr = xu.getSheets(wb, sheetNameArr);
// let dataArr = [];
// for (let i = 0; i < arr.length; i++) {
//     const sheet = arr[i];
//     const rowLen = xu.getSheetRowLen(sheet);
//     console.log(rowLen);

//     // let list = {};
//     // for (j = 2; j <= rowLen; j++) {
//     //     const id = xu.getCellValue(sheet, 'A', j);
//     //     let item = {};
//     //     item.STEM = xu.getCellValue(sheet, 'B', j);
//     //     const answerA = xu.getCellValue(sheet, 'C', j);
//     //     const answerB = xu.getCellValue(sheet, 'D', j);
//     //     const answerC = xu.getCellValue(sheet, 'E', j);
...
//     const fileNameArr = ['ZH', 'TW', 'EN'];
//     const sheetName = fileNameArr[i];
